...
set :application, 'alphabuilds'
set :repository,  'https://github.com/marbemac/AlphaBuilds.git'
set :branch,  'master'
...
set :default_environment, {
    ...
    'GEM_HOME'     => '/usr/local/rvm/gems/ruby-1.9.3-p392@AlphaBuilds',
    'GEM_PATH'     => '/usr/local/rvm/gems/ruby-1.9.3-p392:/usr/local/rvm/gems/ruby-1.9.3-p392@global:/usr/local/rvm/gems/ruby-1.9.3-p392@AlphaBuilds',
    'BUNDLE_PATH'  => '/usr/local/rvm/gems/ruby-1.9.3-p392@AlphaBuilds'  # If you are using bundler.
}
